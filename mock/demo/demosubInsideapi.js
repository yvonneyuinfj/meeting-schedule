...
/**获取列表数据 */
const getDemoSubInsideData = Mock.mock({
  errorDesc: '',
  message: '',
  retCode: '200',
  responseBody: {
...
/**删除数据 */
const deleteDemoSubInsideData = Mock.mock({
  errorDesc: '',
  message: '',
  retCode: '200',
  responseBody: 1
...
module.exports = {
  'GET /demo/template/demosubinsides/search-by-page/v1': getDemoSubInsideData,
  'DELETE /demo/template/demosubinsides/delete-by-ids/v1': deleteDemoSubInsideData
};
