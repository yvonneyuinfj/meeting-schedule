<template>
  <div class="content-wrapper">
    ...
    <AvicExcelImport
      ...
      title="单表模板导入"
      importUrl="/mms/mds/mdsvendoraccounts/importData/v1"
      downloadTemplateUrl="/mms/mds/mdsvendoraccounts/downloadTemplate/v1"
      @reloadData="getList"
...
import { listMdsVendorAccountByPage, delMdsVendorAccount, exportExcel } from '@/api/avic/mms/mds/MdsVendorAccountApi'; // 引入模块API
