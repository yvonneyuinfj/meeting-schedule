        ...
        <div class="table-wrapper">
          ...
          >
            ...
            <template #bodyCell="{ column, text, record, index }">
              ...
              <template v-if="column.dataIndex === 'demoNotnull'">
              ...
              <template v-if="column.dataIndex === 'action'">
                <!--  -->
                <a-button
                  v-hasPermi="['demoMainInside:edit']"
                  type="link"
                  class="inner-btn"
...
import {
  listDemoMainInsideByPage,
  delDemoMainInside,
  updateDemoSwitch
} from '@/api/avic/demo/DemoMainInsideApi'; // 引入模块API
import DemoMainInsideAdd from './DemoMainInsideAdd.vue'; // 引入添加页面组件
import DemoMainInsideEdit from './DemoMainInsideEdit.vue'; // 引入编辑页面组件
import DemoMainInsideDetail from './DemoMainInsideDetail.vue'; // 引入详情页面组件
import DemoSubManage from '../demosubinside/DemoSubManage.vue'; // 引入子表组件
...
const queryForm = ref<DemoMainInsideDto>({}); // 高级查询对象
...
const demoRadioButtonList = ref([]); // 单选按钮通用代码
