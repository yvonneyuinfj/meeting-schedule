        ...
        <a-row :gutter="16">
          ...
          <a-col v-bind="colLayout.cols">
            <a-form-item name="demoRadioButton" label="单选（按钮样式）">
              <a-radio-group v-model:value="form.demoRadioButton" button-style="solid" disabled>
                <a-radio-button
          ...
          <a-col v-bind="colLayout.cols">
            <a-form-item name="demoPhone" label="电话(正则)">
              <a-input v-model:value="form.demoPhone" :maxLength="255" disabled />
            </a-form-item>
          </a-col>
          <a-col v-bind="colLayout.cols">
