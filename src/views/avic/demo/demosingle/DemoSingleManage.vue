<template>
  <div class="content-wrapper">
    ...
    <AvicExcelImport
      ...
      title="单表模板导入"
      importUrl="/demo/template/demosingles/importData/v1"
      downloadTemplateUrl="/demo/template/demosingles/downloadTemplate/v1"
      @reloadData="getList"
...
import type { DemoSingleDto } from '@/api/avic/demo/DemoSingleApi'; // 引入模块DTO
import {
  listDemoSingleByPage,
  delDemoSingle,
  updateDemoSwitch,
  exportExcel
} from '@/api/avic/demo/DemoSingleApi'; // 引入模块API
import DemoSingleAdd from './DemoSingleAdd.vue'; // 引入添加页面组件
import DemoSingleEdit from './DemoSingleEdit.vue'; // 引入编辑页面组件
import DemoSingleDetail from './DemoSingleDetail.vue'; // 引入详情页面组件
import DemoSingleSelect from './DemoSingleSelect.vue'; // 引入弹窗选择页
...
const queryForm = ref<DemoSingleDto>({}); // 高级查询对象
...
const excelParams = ref({ tableName: 'demoSingle' }); // 必填参数tableName全局唯一
