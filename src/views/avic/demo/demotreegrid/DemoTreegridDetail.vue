    ...
    <a-spin :spinning="loading">
      <a-form ref="formRef" :model="form" :rules="rules" layout="horizontal" v-bind="layout">
        <a-row :gutter="16">
          ...
          <a-col v-bind="colLayout.cols">
            <a-form-item name="demoTitle" label="标题">
              <a-input v-model:value="form.demoTitle" disabled />
            </a-form-item>
          </a-col>
          <a-col v-bind="colLayout.cols">
          ...
          <a-col v-bind="colLayout.cols">
            <a-form-item name="treeSort" label="排序号(本级)">
              <a-input-number v-model:value="form.treeSort" disabled />
            </a-form-item>
          </a-col>
          <a-col v-bind="colLayout.cols2">
