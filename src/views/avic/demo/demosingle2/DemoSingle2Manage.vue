<template>
  <div class="content-wrapper">
    ...
    <div class="table-wrapper">
      ...
      >
        ...
        <template #bodyCell="{ column, text, record, index }">
          ...
          <template v-else-if="column.dataIndex === 'demoUserId'">
    ...
    <AvicExcelImport
      ...
      title="单表模板导入"
      importUrl="/demo/demosingle2s/importData/v1"
      downloadTemplateUrl="/demo/demosingle2s/downloadTemplate/v1"
      @reloadData="getList"
...
import { listDemoSingle2ByPage, delDemoSingle2, exportExcel } from '@/api/avic/demo/DemoSingle2Api'; // 引入模块API
import DemoSingle2Add from './DemoSingle2Add.vue'; // 引入添加页面组件
import DemoSingle2Edit from './DemoSingle2Edit.vue'; // 引入编辑页面组件
import DemoSingle2Detail from './DemoSingle2Detail.vue'; // 引入详情页面组件
...
const excelParams = ref({ tableName: 'demoSingle2' }); // 导入Excel数据过滤参数
