      ...
      <a-form ref="formRef" :model="form" :rules="rules" v-bind="layout" layout="horizontal">
        <a-row :gutter="16">
          <a-col v-bind="colLayout.cols">
            <a-form-item label="项目分类编号" name="projectClassCode" has-feedback>
              <a-input
          ...
          <a-col v-bind="colLayout.cols">
            <a-form-item label="项目分类名称" name="projectClassName" has-feedback>
              <a-input
          ...
          <a-col v-bind="colLayout.cols">
            <a-form-item label="项目分类级别" name="projectClassLevel" has-feedback>
              <a-select
          ...
          <a-col v-bind="colLayout.cols">
            <a-form-item label="项目分类管理员" name="projectClassManager" has-feedback>
              <AvicCommonSelect
          ...
          <a-col v-bind="colLayout.cols">
            <a-form-item label="项目分类维护时间" name="projectClassDate" has-feedback>
              <a-date-picker
          ...
          <a-col v-bind="colLayout.cols">
            <a-form-item label="排序" name="projectClassOrder" has-feedback>
              <a-input-number
...
import { useDemoMainForm, emits } from './ts/DemoMainForm'; // 引入表单ts
