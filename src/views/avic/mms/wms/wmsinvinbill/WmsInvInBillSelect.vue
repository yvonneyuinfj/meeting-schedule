<template>
  <div class="content-wrapper">
    ...
    <div class="table-wrapper">
      <AvicTable
        ref="wmsInvInBillSelect"
        table-key="wmsInvInBillSelect"
        :columns="columns"
...
import { listWmsInvInBillByPage } from '@/api/avic/mms/wms/WmsInvInBillApi'; // 引入模块API
const $emit = defineEmits(['select', 'handleRowDblClick']);
const wmsInvInBillSelect = ref();
