  ...
  <AvicSplit horizontal>
    <AvicPane size="55">
      <div class="content-wrapper">
        ...
        <div class="table-wrapper">
          ...
          <a-space>
            ...
            <a-button
              v-hasPermi="['wmsInvInBill:import']"
              title="导入"
              type="primary"
              ghost
              @click="handleImport">
            ...
            <a-button
              v-hasPermi="['wmsInvInBill:export']"
              title="导出"
              type="primary"
              ghost
              @click="handleExport">
      ...
      <AvicExcelImport
        ...
        title="模板导入"
        importUrl="/mms/wms/wmsinvinbills/importData/v1"
        downloadTemplateUrl="/mms/wms/wmsinvinbills/downloadTemplate/v1"
        @reloadData="getList"
    ...
    <AvicPane>
      <!-- 子表组件 -->
      <wms-inv-in-bill-l-manage key="wmsInvInBillLManage" ref="wmsInvInBillLManage" :mainId="mainId" />
    </AvicPane>
  </AvicSplit>
</template>
...
import { listWmsInvInBillByPage, delWmsInvInBill, exportExcel } from '@/api/avic/mms/wms/WmsInvInBillApi'; // 引入模块API
import WmsInvInBillAdd from './WmsInvInBillAdd.vue'; // 引入添加页面组件
import WmsInvInBillEdit from './WmsInvInBillEdit.vue'; // 引入编辑页面组件
import WmsInvInBillDetail from './WmsInvInBillDetail.vue'; // 引入详情页面组件
import WmsInvInBillLManage from '../wmsinvinbilll/WmsInvInBillLManage.vue'; // 引入子表页面组件
...
const queryForm = ref<WmsInvInBillDto>({});
...
const excelParams = ref({ tableName: 'wmsInvInBill' }); // 必填参数tableName全局唯一，与tableKey保持一致
...
function getList () {
  ...
  selectedRows.value = [];
  loading.value = true;
  listWmsInvInBillByPage(queryParam)
    .then(response => {
