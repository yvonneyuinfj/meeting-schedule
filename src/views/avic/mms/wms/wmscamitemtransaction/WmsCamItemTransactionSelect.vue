<template>
  <div class="content-wrapper">
    ...
    <div class="table-wrapper">
      <AvicTable
        ref="wmsCamItemTransactionSelect"
        table-key="wmsCamItemTransactionSelect"
        :columns="columns"
...
import { listWmsCamItemTransactionByPage } from '@/api/avic/mms/wms/WmsCamItemTransactionApi'; // 引入模块API
const $emit = defineEmits(['select', 'handleRowDblClick']);
const wmsCamItemTransactionSelect = ref();
