...
import { listWmsCamItemTransactionByPage } from '@/api/avic/mms/wms/WmsCamItemTransactionApi';
import { emits } from '@/views/avic/mms/wms/wmscamiteminventory/ts/WmsCamItemInventoryForm'; // 引入模块API
...
/** 查询数据  */
function getList() {
  queryParam.searchParams.batchNo = props.info.batchNo;
  queryParam.searchParams.mdsItemCode = props.info.mdsItemCode;
