<template>
  <div class="content-wrapper">
    ...
    <div class="table-wrapper">
      <AvicTable
        ref="wmsCamItemInventorySelect"
        table-key="wmsCamItemInventorySelect"
        :columns="columns"
...
import { listWmsCamItemInventoryByPage } from '@/api/avic/mms/wms/WmsCamItemInventoryApi'; // 引入模块API
const $emit = defineEmits(['select', 'handleRowDblClick']);
const wmsCamItemInventorySelect = ref();
