<template>
  <div class="content-wrapper">
    ...
    <div class="table-wrapper">
      <AvicTable
        ref="wmsItemInventorySelect"
        table-key="wmsItemInventorySelect"
        :columns="columns"
...
import { listWmsItemInventoryByPage } from '@/api/avic/mms/wms/WmsItemInventoryApi'; // 引入模块API
const $emit = defineEmits(['select', 'handleRowDblClick']);
const wmsItemInventorySelect = ref();
