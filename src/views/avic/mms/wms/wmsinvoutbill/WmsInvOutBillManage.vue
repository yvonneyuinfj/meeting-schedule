...
<!--            <a-button-->
<!--              v-hasPermi="['wmsInvOutBill:export']"-->
<!--              title="导出"-->
<!--              type="primary"-->
<!--              ghost-->
<!--              @click="handleExport">-->
...
<!--            </a-button>-->
            ...
            <template #toolBarRight>
              <a-space>
                <AvicBpmFilter
                  :allFileAuth="['wmsInvOutBill:all']"
                  :myFileAuth="['wmsInvOutBill:my']"
    ...
    <AvicPane>
      <!--子表组件-->
      <WmsInvOutBillLManage
        key="wmsInvOutBillLManage"
        ref="wmsInvOutBillLManage"
        :mainId="mainId"
      />
    </AvicPane>
  </AvicSplit>
...
import type { WmsInvOutBillDto } from '@/api/avic/mms/wms/WmsInvOutBillApi'; // 引入模块DTO
import { listWmsInvOutBillByPage, delWmsInvOutBill, exportExcel } from '@/api/avic/mms/wms/WmsInvOutBillApi'; // 引入模块API
import WmsInvOutBillAdd from './WmsInvOutBillAdd.vue'; // 引入添加页面组件
import WmsInvOutBillEdit from './WmsInvOutBillEdit.vue'; // 引入编辑页面组件
import WmsInvOutBillDetail from './WmsInvOutBillDetail.vue'; // 引入详情页面组件
import WmsInvOutBillLManage from './sub/WmsInvOutBillLManage.vue'; // 引入子表页面组件
...
const queryForm = ref<WmsInvOutBillDto>({
  bpmState: 'all',
  bpmType: 'my'
}); // 高级查询对象
...
const billTypeList = ref([]); // 单据类型通用代码
const lookupParams = [
  { fieldName: 'billType', lookUpType: 'WMS_OUT_BILL_TYPE' }
];
...
function getList() {
  ...
  selectedRows.value = [];
  loading.value = true;
  listWmsInvOutBillByPage(queryParam)
    .then(response => {
