...
import { listWmsInvOutBillLByPage, delWmsInvOutBillL } from '@/api/avic/mms/wms/WmsInvOutBillLApi'; // 引入模块API
...
function getList () {
  ...
  selectedRows.value = [];
  loading.value = true;
  queryParam.searchParams.wmsInvOutBillId = props.mainId ? props.mainId : '-1';
