...
import { listFamHandleListByPage, delFamHandleList } from '@/api/avic/mms/fam/FamHandleListApi'; // 引入模块API
...
function getList () {
  ...
  selectedRows.value = [];
  loading.value = true;
  queryParam.searchParams.handleId = props.mainId ? props.mainId : '-1';
