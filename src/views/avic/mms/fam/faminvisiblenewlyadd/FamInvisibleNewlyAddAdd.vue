<template>
  <AvicModal :visible="true" title="添加" width="960px" height="520px" :centered="true" @cancel="closeModal">
        ...
        <a-row>
          ...
          <a-col v-bind="colLayout.cols">
            <a-form-item name="managerDeptId" label="主管部门">
              <AvicCommonSelect v-model:value="form.managerDeptId" type="deptSelect" placeholder="请选择主管部门id" />
            </a-form-item>
          </a-col>
          ...
          <a-col v-bind="colLayout.cols">
            <a-form-item name="handlePersionId" label="经办人">
              <AvicCommonSelect v-model:value="form.handlePersionId" type="userSelect" placeholder="请选择经办人"
                disabled :defaultShowValue='proxy.$getLoginUser().name' />
            </a-form-item>
          </a-col>
          <a-col v-bind="colLayout.cols" hidden>
          ...
          <a-col v-bind="colLayout.cols">
            <a-form-item name="useDeptId" label="使用部门">
              <AvicCommonSelect v-model:value="form.useDeptId" type="deptSelect" placeholder="请选择使用部门"
                disabled :defaultShowValue='proxy.$getLoginUser().deptName' />
            </a-form-item>
          </a-col>
          <a-col v-bind="colLayout.cols" hidden>
    ...
    <template #footer>
      ...
      <a-button title="启动流程" type="primary" :loading="loading" @click="saveAndStartProcess">保存并启动流程</a-button>
