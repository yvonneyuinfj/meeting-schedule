<template>
    <AvicModal :visible="true" title="添加" width="960px" height="520px" :centered="true" @cancel="closeModal">
          ...
          <a-col v-bind="colLayout.cols">
            ...
            <a-col v-bind="colLayout.cols">
              <a-form-item name="reportGroupDate" label="上报集团日期">
                <a-date-picker v-model:value="form.reportGroupDate" format="YYYY-MM-DD" value-format="YYYY-MM-DD"
                  placeholder="请选择上报集团日期" />
              </a-form-item>
            </a-col>
            <a-col v-bind="colLayout.cols">
              <a-form-item name="groupApprovalDoc" label="集团批复文件">
                <a-input v-model:value="form.groupApprovalDoc" :maxLength="64" placeholder="请输入集团批复文件" />
              </a-form-item>
            </a-col>
            <a-col v-bind="colLayout.cols">
              <a-form-item name="approvalTime" label="集团批复时间">
                <a-date-picker v-model:value="form.approvalTime" format="YYYY-MM-DD" value-format="YYYY-MM-DD"
      ...
      <template #footer>
        <a-button title="保存" type="primary" :loading="loading" @click="saveEnter">保存</a-button>
