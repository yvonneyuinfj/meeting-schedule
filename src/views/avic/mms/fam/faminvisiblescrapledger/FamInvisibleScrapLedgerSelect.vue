<template>
  <div class="content-wrapper">
    ...
    <div class="table-wrapper">
      <AvicTable
        ref="famInvisibleScrapLedgerSelect"
        table-key="famInvisibleScrapLedgerSelect"
        :columns="columns"
...
import { listFamInvisibleScrapLedgerByPage } from '@/api/avic/mms/fam/FamInvisibleScrapLedgerApi'; // 引入模块API
const $emit = defineEmits(['select', 'handleRowDblClick']);
const famInvisibleScrapLedgerSelect = ref();
