    ...
    <a-spin :spinning="loading">
      <a-form ref="formRef" :model="form" :rules="rules" v-bind="layout" class="form-excel-style">
        <a-row :gutter="0">
          ...
          <!--                placeholder="请选择入账日期"-->
          <!--                :disabled="formDisable['entryDate']"-->
          <!--              />-->
          <!--            </a-form-item>-->
          <!--          </a-col>-->
          <a-col v-bind="colLayout.cols2">
          ...
          <!--                placeholder="请输入月折旧额"-->
          <!--                style="width: 100%"-->
          <!--                :disabled="formDisable['monDepreciation']"-->
          <!--              ></a-input-number>-->
          <!--            </a-form-item>-->
          <!--          </a-col>-->
          <a-col v-bind="colLayout.cols2">
          ...
          <!--                type="deptSelect"-->
          <!--                placeholder="请选择主管部门"-->
          <!--                :disabled="formDisable['managerDeptId']"-->
          <!--              />-->
          <!--            </a-form-item>-->
          <!--          </a-col>-->
          <a-col v-bind="colLayout.cols2">
          ...
          <!--                style="width: 100%"-->
          <!--                :disabled="formDisable['firstDepreciationValue']"-->
          <!--              ></a-input-number>-->
          <!--            </a-form-item>-->
          <!--          </a-col>-->
          <a-col v-bind="colLayout.cols2">
          ...
          <!--                :maxLength="50"-->
          <!--                placeholder="请输入品牌型号"-->
          <!--                :disabled="formDisable['brandModel']"-->
          <!--              />-->
          <!--            </a-form-item>-->
          <!--          </a-col>-->
          <!--          <a-col v-bind="colLayout.cols2">-->
          ...
          <!--                value-format="YYYY-MM-DD"-->
          <!--                placeholder="请选择购置日期"-->
          <!--                :disabled="formDisable['purchaseDate']"-->
          <!--              />-->
          <!--            </a-form-item>-->
          <!--          </a-col>-->
          <!--          <a-col v-bind="colLayout.cols2">-->
          ...
          <!--                style="width: 100%"-->
          <!--                :disabled="formDisable['currentYearDepreciation']"-->
          <!--              ></a-input-number>-->
          <!--            </a-form-item>-->
          <!--          </a-col>-->
          <!--          <a-col v-bind="colLayout.cols2">-->
          ...
          <!--                :disabled="formDisable['newaCurrentmProvision']"-->
          <!--              />-->
          <!--            </a-form-item>-->
          <!--          </a-col>-->
          <!--          <a-col v-bind="colLayout.cols2">-->
          ...
          <!--                :disabled="formDisable['resetVoucherNo']"-->
          <!--              />-->
          <!--            </a-form-item>-->
          <!--          </a-col>-->
          <!--          <a-col v-bind="colLayout.cols2">
          ...
          <!--                :maxLength="64"-->
          <!--                placeholder="请输入建设项目"-->
          <!--                :disabled="formDisable['buildProject']"-->
          <!--              />-->
          <!--            </a-form-item>-->
          <!--          </a-col>-->
          <a-col v-bind="colLayout.cols2">
