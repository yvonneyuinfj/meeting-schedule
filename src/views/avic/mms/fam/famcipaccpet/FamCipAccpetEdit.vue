    ...
    <a-spin :spinning="loading">
      ...
      >
        <a-row :gutter="0">
          ...
          <a-col v-bind="colLayout.cols">
            <a-form-item name="accpetType" label="验收类型（新增/改造）" has-feedback>
              <a-select
          ...
          <a-col v-bind="colLayout.cols">
            <a-form-item name="procureDeptId" label="采购部门id">
              <AvicCommonSelect
        ...
        <FamCipAccpetListEdit ref="famCipAccpetListEdit" :mainId="formId || form.id" />
      </a-form>
    </a-spin>
    <template #footer>
