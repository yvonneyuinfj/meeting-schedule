<template>
  <div class="content-wrapper">
    ...
    <div class="table-wrapper">
      ...
      >
        ...
        <template #bodyCell="{ column, text, record, index }">
          ...
          <template v-else-if="column.dataIndex === 'assetCode'">
    ...
    <AvicExcelImport
      ...
      title="单表模板导入"
      importUrl="/mms/fam/famscrapledgers/importData/v1"
      downloadTemplateUrl="/mms/fam/famscrapledgers/downloadTemplate/v1"
      @reloadData="getList"
...
import { listFamScrapLedgerByPage, delFamScrapLedger, exportExcel } from '@/api/avic/mms/fam/FamScrapLedgerApi'; // 引入模块API
import FamScrapLedgerAdd from './FamScrapLedgerAdd.vue'; // 引入添加页面组件
import FamScrapLedgerEdit from './FamScrapLedgerEdit.vue'; // 引入编辑页面组件
import FamScrapLedgerDetail from './FamScrapLedgerDetail.vue'; // 引入详情页面组件
...
const excelParams = ref({ tableName: 'famScrapLedger' }); // 导入Excel数据过滤参数
