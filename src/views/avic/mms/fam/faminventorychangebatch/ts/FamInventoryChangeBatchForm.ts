...
import { getFamInventoryChangeBatch, saveFamInventoryChangeBatch, saveFormAndStartProcess } from '@/api/avic/mms/fam/FamInventoryChangeBatchApi'; // 引入模块API
import {
...
export function useFamInventoryChangeBatchForm({ props: props, emit: emit }) {
  ...
  const formCode = 'FamInventoryChangeBatch';
