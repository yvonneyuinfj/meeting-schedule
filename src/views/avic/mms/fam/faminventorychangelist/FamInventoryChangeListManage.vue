...
import { listFamInventoryChangeListByPage, delFamInventoryChangeList } from '@/api/avic/mms/fam/FamInventoryChangeListApi'; // 引入模块API
...
function getList () {
  ...
  selectedRows.value = [];
  loading.value = true;
  queryParam.searchParams.inventoryChangeId = props.mainId ? props.mainId : '-1';
