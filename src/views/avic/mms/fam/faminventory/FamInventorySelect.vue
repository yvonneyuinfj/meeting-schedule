  ...
  <div class="content-wrapper">
    ...
    <div class="table-wrapper">
      <AvicTable
        ref="famInventorySelect"
        table-key="famInventorySelect"
        :columns="columns"
...
import { listFamInventoryByPage } from '@/api/avic/mms/fam/FamInventoryApi'; // 引入模块API
const $emit = defineEmits(['select', 'handleRowDblClick']);
const famInventorySelect = ref();
