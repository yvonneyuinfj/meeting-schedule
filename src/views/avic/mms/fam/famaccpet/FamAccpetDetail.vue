<template>
  <div>
        ...
        <a-row>
          <a-col v-bind="colLayout.cols" v-if="fieldVisible('accpetApplyNo')">
            <a-form-item name="accpetApplyNo" label="验收申请单号" :rules="fieldRequired('accpetApplyNo')" has-feedback>
              ...
              /> -->
              <a-input v-model:value="form.accpetApplyNo" :disabled="fieldDisabled('accpetApplyNo')" />
            </a-form-item>
          </a-col>
          <a-col v-bind="colLayout.cols" v-if="fieldVisible('accpetType')">
            <a-form-item name="accpetType" label="验收类型" :rules="fieldRequired('accpetType')" has-feedback>
              <a-select v-model:value="form.accpetType" :auto-focus="true"
                ...
                :show-search="true" :allow-clear="true" :disabled="fieldDisabled('accpetType')">
          ...
          <a-col v-bind="colLayout.cols" v-if="fieldVisible('procureDeptName')">
            <a-form-item name="procureDeptName" label="采购部门名称" :rules="fieldRequired('procureDeptName')" has-feedback>
              <AvicCommonSelect v-model:value="form.procureDeptName" type="deptSelect"
                :defaultShowValue="form.procureDeptNameAlias" :disabled="fieldDisabled('procureDeptName')" />
            </a-form-item>
          </a-col>
          ...
          <a-col v-bind="colLayout.cols" v-if="fieldVisible('assetClass')">
            <a-form-item name="assetClass" label="资产属性" :rules="fieldRequired('assetClass')" has-feedback>

              <a-select v-model:value="form.assetClass" :auto-focus="true"
                :get-popup-container="triggerNode => triggerNode.parentNode" option-filter-prop="children"
                :show-search="true" :allow-clear="true" placeholder="请选择验收类型" :disabled="fieldDisabled('assetClass')">
          ...
          <a-col v-bind="colLayout.cols" v-if="fieldVisible('fundSource')">
            <a-form-item name="fundSource" label="资金来源" :rules="fieldRequired('fundSource')" has-feedback>
              <a-select v-model:value="form.fundSource" :auto-focus="true"
                :get-popup-container="triggerNode => triggerNode.parentNode" option-filter-prop="children"
                :show-search="true" :allow-clear="true" placeholder="请选择验收类型" :disabled="fieldDisabled('fundSource')">
          ...
          <a-col v-bind="colLayout.cols" v-if="fieldVisible('purchWay')">
            <a-form-item name="purchWay" label="购置方式" :rules="fieldRequired('purchWay')" has-feedback>
              <a-select v-model:value="form.purchWay" :auto-focus="true"
                :get-popup-container="triggerNode => triggerNode.parentNode" option-filter-prop="children"
                :show-search="true" :allow-clear="true" placeholder="请选择验收类型" :disabled="fieldDisabled('purchWay')">
          ...
          <a-col v-bind="colLayout.cols" v-if="fieldVisible('handlePersonName')">
            <a-form-item name="handlePersonName" label="经办人名称" :rules="fieldRequired('handlePersonName')" has-feedback>
              <AvicCommonSelect v-model:value="form.handlePersonName" type="userSelect"
                :defaultShowValue="form.handlePersonNameAlias" :disabled="fieldDisabled('handlePersonName')" />
            </a-form-item>
          </a-col>
      ...
      <FamAccpetListEdit v-if="fieldVisible('FAM_ACCPET_LIST')" ref="famAccpetListEdit" :mainId="formId || form.id"
        :bpmInstanceObject="bpmInstanceObject" :bpmParams="bpmParams" />
      <!--子表按钮的流程解析，用于权限控制-->
