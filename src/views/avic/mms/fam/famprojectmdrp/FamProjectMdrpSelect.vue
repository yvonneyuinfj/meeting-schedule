<template>
  <div class="content-wrapper">
    ...
    <div class="table-wrapper">
      <AvicTable
        ref="famProjectMdrpSelect"
        table-key="famProjectMdrpSelect"
        :columns="columns"
...
import { listFamProjectMdrpByPage } from '@/api/avic/mms/fam/FamProjectMdrpApi'; // 引入模块API
const $emit = defineEmits(['select', 'handleRowDblClick']);
const famProjectMdrpSelect = ref();
