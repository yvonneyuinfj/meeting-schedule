                ...
                <a-row :gutter="0">
                  <a-col v-bind="colLayout.cols">
                    <a-form-item name="applyNo" label="申请单编号" has-feedback>
                      <avic-auto-code v-model:value="form.applyNo" ref="autoCode" code-type="FAM_BILL_NO"
                        code-param="FAM_SEAL_AND_UNSEAL" :allow-clear="true" :disabled="false" placeholder="请输入申请单编号" />
                    </a-form-item>
                  </a-col>
                  <a-col v-bind="colLayout.cols">
