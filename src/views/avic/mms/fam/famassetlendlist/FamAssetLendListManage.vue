...
import { listFamAssetLendListByPage, delFamAssetLendList } from '@/api/avic/mms/fam/FamAssetLendListApi'; // 引入模块API
...
function getList () {
  ...
  selectedRows.value = [];
  loading.value = true;
  queryParam.searchParams.assetLendId = props.mainId ? props.mainId : '-1';
