<template>
  <AvicSplit horizontal>
        ...
        <div class="table-wrapper">
          ...
          <a-space>
            ...
            <template #toolBarRight>
              <a-space>
                <AvicBpmFilter
                  :allFileAuth="['famScrap:all']"
                  :myFileAuth="['famScrap:my']"
    ...
    <AvicPane>
      <!--子表组件-->
      <FamScrapListManage
        key="famScrapListManage"
        ref="famScrapListManage"
        :mainId="mainId"
      />
    </AvicPane>
  </AvicSplit>
...
import type { FamScrapDto } from '@/api/avic/mms/fam/FamScrapApi'; // 引入模块DTO
import { listFamScrapByPage, delFamScrap, exportExcel } from '@/api/avic/mms/fam/FamScrapApi'; // 引入模块API
import FamScrapAdd from './FamScrapAdd.vue'; // 引入添加页面组件
import FamScrapEdit from './FamScrapEdit.vue'; // 引入编辑页面组件
import FamScrapDetail from './FamScrapDetail.vue'; // 引入详情页面组件
import FamScrapListManage from '../famscraplist/FamScrapListManage.vue'; // 引入子表页面组件
...
const queryForm = ref<FamScrapDto>({
  bpmState: 'all',
  bpmType: 'my'
}); // 高级查询对象
