...
import { listFamAssetTransferListByPage, delFamAssetTransferList } from '@/api/avic/mms/fam/FamAssetTransferListApi'; // 引入模块API
...
function getList () {
  ...
  selectedRows.value = [];
  loading.value = true;
  queryParam.searchParams.assetTransferId = props.mainId ? props.mainId : '-1';
