...
import { listFamScrapListByPage, delFamScrapList } from '@/api/avic/mms/fam/FamScrapListApi'; // 引入模块API
...
function getList () {
  ...
  selectedRows.value = [];
  loading.value = true;
  queryParam.searchParams.scrapId = props.mainId ? props.mainId : '-1';
