<template>
  <div class="content-wrapper">
    ...
    <div class="table-wrapper">
      <AvicTable
        ref="tpmTempMaintModifyPlanSelect"
        table-key="tpmTempMaintModifyPlanSelect"
        :columns="columns"
...
import { listTpmTempMaintModifyPlanByPage } from '@/api/avic/mms/tpm/TpmTempMaintModifyPlanApi'; // 引入模块API
const $emit = defineEmits(['select', 'handleRowDblClick']);
const tpmTempMaintModifyPlanSelect = ref();
