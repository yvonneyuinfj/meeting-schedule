<template>
  ...
  >
              ...
              >
                <template #suffix>
                  <a-tooltip title="Extra information">
                    <OrderedListOutlined style="color: rgba(0, 0, 0, 0.45)" />
                  </a-tooltip>
                </template>
              </a-input>
              <!-- <AvicModalSelect
        ...
        <a-row>
          ...
          <a-col v-bind="colLayout.cols">
            <a-form-item name="model" label="设备型号">
              <a-input v-model:value="form.model" disabled placeholder="请输入设备型号" />
            </a-form-item>
          </a-col>
          <a-col v-bind="colLayout.cols">
          ...
          <a-col v-bind="colLayout.cols">
            <a-form-item name="oldLastMaintenPlanDate" label="上次保养日期">
              <a-input
    ...
    >
      ...
      <tpm-standard-maintenance-select ref="tpmStandardMaintenanceSelect" style="height: 350px" />
      <!-- </div> -->
    </a-modal>
  </AvicModal>
</template>
...
function handleSummit() {
  ...
  form.value.maintUserId = techUserId;
  // form.value.planMaintenanceDate = lastMaintenDate;
  ...
  form.value.tpmStandardMaintenanceId = id;
  form.value.tpmInventoryId = tpmInventoryId;
  form.value.oldLastMaintenPlanDate = lastMaintenDate;
}
