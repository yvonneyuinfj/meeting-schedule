          ...
          <a-col v-bind="colLayout.cols">
            <a-form-item name="equipmentCode" label="设备编号" has-feedback>
              <AvicModalSelect v-model:value="form.equipmentCode" title="选择设备编号" placeholder="请选择设备编号" valueField=""
                showField="" :selectComponent="tpmInventorySelectComponent" :defaultShowValue="form.equipmentCode"
                disabled :allow-clear="true" />
            </a-form-item>
          </a-col>
          <a-col v-bind="colLayout.cols">
...
import tpmInventorySelect from '@/views/avic/mms/tpm/tpminventory/TpmInventorySelect.vue'; // 引入弹窗选择页
