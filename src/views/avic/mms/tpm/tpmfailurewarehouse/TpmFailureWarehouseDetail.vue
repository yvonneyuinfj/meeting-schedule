...
import { useTpmFailureWarehouseForm, emits } from './ts/TpmFailureWarehouseForm';
import TpmInventoryFailureSelect from '@/views/avic/mms/tpm/tpmfailurewarehouse/TpmInventoryFailureSelect.vue'; // 引入表单ts
