<template>
  <AvicSplit horizontal>
        ...
        <div class="table-wrapper">
          ...
          >
            <template #toolBarLeft>
              <a-space>
                <a-button
                    v-hasPermi="['tpmStandardQuery:export']"
                    title="导出"
                    type="primary"
                    ghost
                    @click="handleExport">
    ...
    <AvicPane>
      <!-- 子表组件 -->
      <tpm-standard-maintenance-query-manage key="tpmStandardMaintenanceQueryManage"
                                             ref="tpmStandardMaintenanceQueryManage" :mainId="mainId"/>
    </AvicPane>
  </AvicSplit>
</template>
