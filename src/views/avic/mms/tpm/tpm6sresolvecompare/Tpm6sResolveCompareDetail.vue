      ...
      <a-row>     
        <a-col v-bind="colLayout.cols" v-if="fieldVisible('billNo')">
         ...
         <a-col v-bind="colLayout.cols" v-if="fieldVisible('problemFinderName')">
          <a-form-item name="problemFinderName" label="问题发现人" :rules="fieldRequired('problemFinderName')" has-feedback>
            <a-input
       ...
       <a-col v-bind="colLayout.cols" v-if="fieldVisible('location')">
        ...
        <a-col v-bind="colLayout.cols" v-if="fieldVisible('secretLevel')">
         ...
         <a-col v-bind="colLayout.cols" v-if="fieldVisible('problemSolvingEvaluation')">
          <a-form-item name="problemSolvingEvaluation" label="六源问题的解决评价" :rules="fieldRequired('problemSolvingEvaluation')" has-feedback>
            <a-select
          ...
          <a-col v-bind="colLayout.cols2">
            ...
            <div class="Richtext">
                ...
                <Editor
                  ...
                  v-model:value="form.problemSolvingInstructions"
