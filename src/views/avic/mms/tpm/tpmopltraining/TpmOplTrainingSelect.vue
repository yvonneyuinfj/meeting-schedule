<template>
  <div class="content-wrapper">
    ...
    <div class="table-wrapper">
      <AvicTable
        ref="tpmOplTrainingSelect"
        table-key="tpmOplTrainingSelect"
        :columns="columns"
...
import { listTpmOplTrainingByPage } from '@/api/avic/mms/tpm/TpmOplTrainingApi'; // 引入模块API
const $emit = defineEmits(['select', 'handleRowDblClick']);
const tpmOplTrainingSelect = ref();
