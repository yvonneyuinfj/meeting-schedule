...
import { getTpmArea, saveTpmArea, basePath } from '@/api/avic/mms/tpm/TpmAreaApi'; // 引入模块API
export const emits = ['afterAddTreeNode', 'afterEditTreeNode', 'close'];
export function useTpmAreaForm({ props: props, emit: emit }) {
  const { proxy } = getCurrentInstance();
  const form = ref<TpmAreaDto>({
 ...
 loading.value = false;
  ...
  /**
     ...
     * @param deptname
     */
   function receptDeptCallback(deptname) {
