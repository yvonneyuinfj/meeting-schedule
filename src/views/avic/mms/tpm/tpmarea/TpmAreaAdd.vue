    ...
    <a-spin :spinning="loading">
      <a-form ref="formRef" :model="form" :rules="rules" layout="horizontal" v-bind="layout">
        <a-row :gutter="16">
          ...
          <a-col v-bind="colLayout.cols">
            <a-form-item name="areaCode" label="区域编号" has-feedback>
              <a-input
          ...
          <a-col v-bind="colLayout.cols">
            <a-form-item name="areaName" label="区域名称" has-feedback>
              <a-input
          ...
          <a-col v-bind="colLayout.cols">
            <a-form-item name="useDeptId" label="使用单位" has-feedback>
              <AvicCommonSelect
