<template>
  <div class="content-wrapper">
        ...
        <a-row :gutter="16">
          ...
          <a-col v-bind="colLayout.cols" v-show="advanced">
            <a-form-item label="项目等级">
              <a-input
                v-model:value="queryForm.projectGrade"
                placeholder="请输入项目等级"
                :allow-clear="true"
                @pressEnter="handleQuery"
              />
          ...
          <a-col v-bind="colLayout.cols" v-show="advanced">
            <a-form-item label="项目经理CODE">
              <a-input
                v-model:value="queryForm.projectManagerCode"
                placeholder="请输入项目经理CODE"
                :allow-clear="true"
                @pressEnter="handleQuery"
              />
            </a-form-item>
          ...
          <a-col v-bind="colLayout.cols" v-show="advanced">
            <a-form-item label="项目经理NAME">
              <a-input
                v-model:value="queryForm.projectManagerName"
                placeholder="请输入项目经理NAME"
                :allow-clear="true"
                @pressEnter="handleQuery"
              />
            </a-form-item>
          ...
          <a-col v-bind="colLayout.cols" v-show="advanced">
            <a-form-item label="责任部门CODE">
              <a-input
                v-model:value="queryForm.responsibleDeptCode"
                placeholder="请输入责任部门CODE"
                :allow-clear="true"
                @pressEnter="handleQuery"
              />
            </a-form-item>
          ...
          <a-col v-bind="colLayout.cols" v-show="advanced">
            <a-form-item label="责任部门NAME">
              <a-input
                v-model:value="queryForm.responsibleDeptName"
                placeholder="请输入责任部门NAME"
                :allow-clear="true"
                @pressEnter="handleQuery"
              />
            </a-form-item>
          ...
          <a-col v-bind="colLayout.cols" v-show="advanced">
            <a-form-item label="申请部门编码">
              <a-input
                v-model:value="queryForm.applyedDeptCode"
          ...
          <a-col v-bind="colLayout.cols" v-show="advanced">
            <a-form-item label="申请部门名称">
              <a-input
                v-model:value="queryForm.applyedDeptName"
          ...
          <a-col v-bind="colLayout.cols" v-show="advanced">
            <a-form-item label="协作部门CODE">
              <a-input
                v-model:value="queryForm.cooperationDeptCode"
                placeholder="请输入协作部门CODE"
                :allow-clear="true"
                @pressEnter="handleQuery"
              />
            </a-form-item>
          ...
          <a-col v-bind="colLayout.cols" v-show="advanced">
            <a-form-item label="协作部门NAME">
              <a-input
                v-model:value="queryForm.cooperationDeptName"
                placeholder="请输入协作部门NAME"
                :allow-clear="true"
                @pressEnter="handleQuery"
              />
            </a-form-item>
    ...
    <div class="table-wrapper">
      <AvicTable
        ref="mdsProjectSimplifySelect"
        table-key="mdsProjectSimplifySelect"
        :columns="columns"
...
import { listMdsProjectSimplifyByPage } from '@/api/avic/mms/mds/MdsProjectSimplifyApi'; // 引入模块API
const $emit = defineEmits(['select', 'handleRowDblClick']);
const mdsProjectSimplifySelect = ref();
