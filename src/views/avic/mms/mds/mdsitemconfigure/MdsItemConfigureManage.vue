<template>
  <div class="content-wrapper">
    ...
    <div class="table-wrapper">
      <AvicTable
        ref="mdsItemConfigure"
        table-key="mdsItemConfigure"
        :columns="columns"
      ...
      >
        <template #toolBarLeft>
          <a-space>
            <a-button
              v-hasPermi="['mdsItemConfigure:add']"
              title="添加"
              type="primary"
              @click="handleAdd"
            >
            ...
            <a-button
              v-hasPermi="['mdsItemConfigure:del']"
              title="删除"
              danger
            ...
            <a-button
              v-hasPermi="['mdsItemConfigure:import']"
              title="导入"
              type="primary"
              ghost
              @click="handleImport">
            ...
            <a-button
              v-hasPermi="['mdsItemConfigure:export']"
              title="导出"
              type="primary"
              ghost
              @click="handleExport">
    ...
    <AvicExcelImport
      ...
      title="单表模板导入"
      importUrl="/mms/mds/mdsitemconfigures/importData/v1"
      downloadTemplateUrl="/mms/mds/mdsitemconfigures/downloadTemplate/v1"
      @reloadData="getList"
...
import { listMdsItemConfigureByPage, delMdsItemConfigure, exportExcel } from '@/api/avic/mms/mds/MdsItemConfigureApi'; // 引入模块API
import MdsItemConfigureAdd from './MdsItemConfigureAdd.vue'; // 引入添加页面组件
import MdsItemConfigureEdit from './MdsItemConfigureEdit.vue'; // 引入编辑页面组件
import MdsItemConfigureDetail from './MdsItemConfigureDetail.vue'; // 引入详情页面组件
...
const excelParams = ref({ tableName: 'mdsItemConfigure' }); // 导入Excel数据过滤参数
