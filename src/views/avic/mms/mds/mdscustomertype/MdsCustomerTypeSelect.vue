<template>
  <div class="content-wrapper">
    <div class="top-search-box">
      ...
      <a-form v-bind="layout" ref="formRef" :model="queryForm">
        <a-row :gutter="16">
          ...
          <a-col v-bind="colLayout.cols">
            <a-form-item label="父类型ID">
              <a-input
                v-model:value="queryForm.parentTypeId"
    ...
    <div class="table-wrapper">
      <AvicTable
        ref="mdsCustomerTypeSelect"
        table-key="mdsCustomerTypeSelect"
        :columns="columns"
...
import { listMdsCustomerTypeByPage } from '@/api/avic/mms/mds/MdsCustomerTypeApi'; // 引入模块API
const $emit = defineEmits(['select', 'handleRowDblClick']);
const mdsCustomerTypeSelect = ref();
