      ...
      >
        <a-row :gutter="16">
          ...
          <a-col v-bind="colLayout.cols">
            <a-form-item name="parentMdsLocatorIdAlias" label="上级库位">
              <a-input v-model:value="form.parentMdsLocatorIdAlias" placeholder="选择上级库位" @click="locatorClick">
                <template #suffix>
                  <a-tooltip title="库位">
          ...
          <a-col v-bind="colLayout.cols">
            <a-form-item name="mdsInventoryIdAlias" label="库房">
              <a-input  v-model:value="form.mdsInventoryIdAlias"  placeholder="请选择库房"  @click="inventoryClick">
                <template #suffix>
                  <a-tooltip title="库房">
                    <ApartmentOutlined style="color: rgba(0, 0, 0, 0.45)" />
                  </a-tooltip>
          ...
          <a-col v-bind="colLayout.cols" hidden>
            <a-form-item name="parentMdsLocatorId" label="父库位ID">
              <a-input
                v-model:value="form.parentMdsLocatorId"
                :maxLength="64"
...
const getLocatorId = (v) => {
  ...
  form.value.parentMdsLocatorIdAlias = v.locatorNo;
  mdsLocatorModal.value = false;
};
const getInventoryId = (v) => {
  form.value.mdsInventoryId = v.id;
  form.value.mdsInventoryIdAlias = v.inventoryName;
  mdsInventoryModal.value = false;
};
</script>
