    ...
    <a-spin :spinning="loading">
      ...
      >
        <a-row :gutter="16">
          ...
          <a-col v-bind="colLayout.cols">
            <a-form-item name="planBalanceFlag" label="参与计划平衡标记 ^ 是否参与MRP计划平衡的标记:  Y --是;  N --不是" has-feedback>
              <a-input
                v-model:value="form.planBalanceFlag"
                :maxLength="2"
          ...
          <a-col v-bind="colLayout.cols">
            <a-form-item name="fundCalculateFlag" label="参与资金计算标记 ^ 是否参与成本资金计算的标记: Y --是;  N --不是" has-feedback>
              <a-input
                v-model:value="form.fundCalculateFlag"
                :maxLength="2"
          ...
          <a-col v-bind="colLayout.cols">
            <a-form-item name="jitFlag" label="JIT库房标记 ^ Y --是; N --不是" has-feedback>
              <a-input
                v-model:value="form.jitFlag"
                :maxLength="2"
          ...
          <a-col v-bind="colLayout.cols">
            <a-form-item name="purchaseBalanceFlag" label="参与采购平衡标记 ^  N --不是; Y --是" has-feedback>
              <a-input
                v-model:value="form.purchaseBalanceFlag"
                :maxLength="2"
          ...
          <a-col v-bind="colLayout.cols">
            <a-form-item name="filterFlag" label="是否筛选 ^ N -不筛选;Y -筛选" has-feedback>
              <a-input
                v-model:value="form.filterFlag"
                :maxLength="2"
          ...
          <a-col v-bind="colLayout.cols">
            <a-form-item name="minusQtyFlag" label="是否允许有负库存 ^ N --否；Y --是" has-feedback>
              <a-input
                v-model:value="form.minusQtyFlag"
                :maxLength="2"
          ...
          <a-col v-bind="colLayout.cols">
            <a-form-item name="consignmentFlag" label="是否寄售库房 ^ N --否；Y --是" has-feedback>
              <a-input
                v-model:value="form.consignmentFlag"
                :maxLength="2"
          ...
          <a-col v-bind="colLayout.cols">
            <a-form-item name="ynBalancing" label="盘点状态 ^ 0-未盘点；1-盘点中">
              <a-input
                v-model:value="form.ynBalancing"
                :maxLength="4"
          ...
          <a-col v-bind="colLayout.cols">
            <a-form-item name="ynInventoryMerge" label="库存台帐合并标记" has-feedback>
              <a-input
                v-model:value="form.ynInventoryMerge"
                :maxLength="4"
          ...
          <a-col v-bind="colLayout.cols">
            <a-form-item name="ynOilSealWarn" label="是否参与油封期预警">
              <a-input
                v-model:value="form.ynOilSealWarn"
                :maxLength="4"
          ...
          <a-col v-bind="colLayout.cols">
            <a-form-item name="oilSealWarnDays" label="油封期提前预警天数">
              <a-input
                v-model:value="form.oilSealWarnDays"
                :maxLength="20"
          ...
          <a-col v-bind="colLayout.cols">
            <a-form-item name="ynRecheckWarn" label="是否参与复验期预警">
              <a-input
                v-model:value="form.ynRecheckWarn"
                :maxLength="4"
          ...
          <a-col v-bind="colLayout.cols">
            <a-form-item name="recheckWarnDays" label="复验期提前预警天数">
              <a-input
                v-model:value="form.recheckWarnDays"
                :maxLength="20"
          ...
          <a-col v-bind="colLayout.cols">
            <a-form-item name="ynEffectStockWarn" label="是否参与保管期预警">
              <a-input
                v-model:value="form.ynEffectStockWarn"
                :maxLength="4"
          ...
          <a-col v-bind="colLayout.cols">
            <a-form-item name="effectStockWarnDays" label="保管期提前预警天数">
              <a-input
                v-model:value="form.effectStockWarnDays"
                :maxLength="20"
          ...
          <a-col v-bind="colLayout.cols">
            <a-form-item name="ynBacklogWarn" label="是否参与积压预警">
              <a-input
                v-model:value="form.ynBacklogWarn"
                :maxLength="4"
          ...
          <a-col v-bind="colLayout.cols">
            <a-form-item name="backlogWarnDays" label="积压提前预警天数">
              <a-input
                v-model:value="form.backlogWarnDays"
                :maxLength="20"
          ...
          <a-col v-bind="colLayout.cols">
            <a-form-item name="ynOverstockWarn" label="是否参与超储预警">
              <a-input
                v-model:value="form.ynOverstockWarn"
                :maxLength="4"
          ...
          <a-col v-bind="colLayout.cols">
            <a-form-item name="overstockWarnRatio" label="超储警戒系数%">
              <a-input
                v-model:value="form.overstockWarnRatio"
                :maxLength="20"
          ...
          <a-col v-bind="colLayout.cols">
            <a-form-item name="lackWarnRatio" label="缺货警戒系数%">
              <a-input
                v-model:value="form.lackWarnRatio"
                :maxLength="20"
          ...
          <a-col v-bind="colLayout.cols">
            <a-form-item name="ynOrderPointWarn" label="是否参与订货点预警">
              <a-input
                v-model:value="form.ynOrderPointWarn"
                :maxLength="4"
          ...
          <a-col v-bind="colLayout.cols">
            <a-form-item name="orderPointWarnRatio" label="订货点警戒系数%">
              <a-input
                v-model:value="form.orderPointWarnRatio"
                :maxLength="20"
