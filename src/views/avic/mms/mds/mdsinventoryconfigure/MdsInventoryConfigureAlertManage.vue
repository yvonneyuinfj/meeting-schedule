<template>
  <AvicSplit horizontal>
        ...
        <div class="table-wrapper">
          <AvicTable ref="mdsInventory" table-key="mdsInventory" :columns="columns" :row-key="record => record.id"
            ...
            <template #toolBarRight>
              <a-input-search class="opt-btn-commonsearch" style="width: 200px" placeholder="请输入库房代码或库房名称"
    ...
    <AvicPane>
      <!-- 子表组件 -->
      <mds-inventory-configure-edit key="mdsInventoryConfigureEdit" ref="mdsInventoryConfigureEdit" :form-id="formId"
        @reloadData="getList" />
    </AvicPane>
  </AvicSplit>
</template>
...
import MdsInventoryConfigureEdit from './MdsInventoryConfigureFormEdit.vue'; // 引入表单页面组件
...
//       loading.value = true;
//       // 处理数据
//       form.value.mdsInventoryId = mainId;
//       //alert(props.formId);
