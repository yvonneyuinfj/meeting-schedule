<template>
  <div class="content-wrapper">
        ...
        <a-row :gutter="16">
          <a-col v-bind="colLayout.cols">
            <a-form-item label="表格编号">
              <a-input
                v-model:value="queryForm.gridCode"
                placeholder="请输入表格编号"
                :allow-clear="true"
          ...
          <a-col v-bind="colLayout.cols">
            <a-form-item label="表格名称">
              <a-input
                v-model:value="queryForm.gridName"
                placeholder="请输入表格名称"
                :allow-clear="true"
                @pressEnter="handleQuery"
              />
          ...
          <a-col v-bind="colLayout.cols">
            <a-form-item label="表格描述">
              <a-input
                v-model:value="queryForm.gridDesc"
                placeholder="请输入表格描述"
                :allow-clear="true"
                @pressEnter="handleQuery"
              />
    ...
    <div class="table-wrapper">
      <AvicTable
        ref="mdsGpioTempletGridSelect"
        table-key="mdsGpioTempletGridSelect"
        :columns="columns"
...
import { listMdsGpioTempletGridByPage } from '@/api/avic/mms/mds/MdsGpioTempletGridApi'; // 引入模块API
const $emit = defineEmits(['select', 'handleRowDblClick']);
const mdsGpioTempletGridSelect = ref();
