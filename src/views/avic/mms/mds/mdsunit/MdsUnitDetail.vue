      ...
      >
        <a-row :gutter="16">
          <a-col v-bind="colLayout.cols">
            <a-form-item name="unitCode" label="计量单位代码">
              <a-input v-model:value="form.unitCode" :auto-focus="true" disabled/>
            </a-form-item>
          </a-col>
          <a-col v-bind="colLayout.cols">
            <a-form-item name="unitDesc" label="计量单位说明">
              <a-input v-model:value="form.unitDesc" disabled/>
            </a-form-item>
          </a-col>
          <a-col v-bind="colLayout.cols">
            <a-form-item name="unitClass" label="计量单位大类">
              <a-select
