      ...
      <a-form ref="formRef" :model="form" layout="horizontal" v-bind="layout">
        <a-row :gutter="16">
          <a-col v-bind="colLayout.cols">
            <a-form-item name="vendorCode" label="供应商编码">
              <a-input v-model:value="form.vendorCode" :auto-focus="true" disabled />
            </a-form-item>
          </a-col>
          <a-col v-bind="colLayout.cols">
            <a-form-item name="vendorName" label="企业名称">
              <a-input v-model:value="form.vendorName" disabled />
            </a-form-item>
          </a-col>
          <a-col v-bind="colLayout.cols">
            <a-form-item name="internalCode" label="集团编码">
              <a-input v-model:value="form.internalCode" disabled />
            </a-form-item>
          </a-col>
          <a-col v-bind="colLayout.cols">
            <a-form-item name="uniteCode" label="五证统一编码">
              <a-input v-model:value="form.uniteCode" disabled />
            </a-form-item>
          </a-col>
          <a-col v-bind="colLayout.cols">
            <a-form-item name="vendorEnName" label="企业英文名">
              <a-input v-model:value="form.vendorEnName" disabled />
            </a-form-item>
          </a-col>
          <a-col v-bind="colLayout.cols">
            <a-form-item name="vendorAlias" label="企业别名">
              <a-input v-model:value="form.vendorAlias" disabled />
            </a-form-item>
          </a-col>
          <a-col v-bind="colLayout.cols">
            <a-form-item name="vendorShortName" label="企业简称">
              <a-input v-model:value="form.vendorShortName" disabled />
            </a-form-item>
          </a-col>
          <a-col v-bind="colLayout.cols">
            <a-form-item name="vendorEnShortName" label="企业英文简称">
              <a-input v-model:value="form.vendorEnShortName" disabled />
            </a-form-item>
          </a-col>
          <a-col v-bind="colLayout.cols">
          ...
          <a-col v-bind="colLayout.cols">
            <a-form-item name="sysCountry" label="国家/地区 代码">
              <a-input v-model:value="form.sysCountry" disabled />
            </a-form-item>
          </a-col>
          <a-col v-bind="colLayout.cols">
            <a-form-item name="sysCity" label="城市 代码">
              <a-input v-model:value="form.sysCity" disabled />
            </a-form-item>
          </a-col>
          <a-col v-bind="colLayout.cols">
          ...
          <a-col v-bind="colLayout.cols">
            <a-form-item name="contactAddress" label="供应商通讯地址">
              <a-input v-model:value="form.contactAddress" disabled />
            </a-form-item>
          </a-col>
          <a-col v-bind="colLayout.cols">
            <a-form-item name="registeredAddress" label="供应商注册地址">
              <a-input v-model:value="form.registeredAddress" disabled />
            </a-form-item>
          </a-col>
          <a-col v-bind="colLayout.cols">
          ...
          <a-col v-bind="colLayout.cols">
            <a-form-item name="businessEntity" label="企业法人">
              <a-input v-model:value="form.businessEntity" disabled />
            </a-form-item>
          </a-col>
          <a-col v-bind="colLayout.cols">
          ...
          <a-col v-bind="colLayout.cols">
            <a-form-item name="statisticsLicense" label="许可证编号">
              <a-input v-model:value="form.statisticsLicense" disabled />
            </a-form-item>
          </a-col>
          <a-col v-bind="colLayout.cols">
...
min="0"
          ...
          <a-col v-bind="colLayout.cols">
            <a-form-item name="businessLicenseNum" label="营业执照号">
              <a-input v-model:value="form.businessLicenseNum" disabled />
            </a-form-item>
          </a-col>
          <a-col v-bind="colLayout.cols">
            <a-form-item name="organizationCode" label="承制单位资格注册编号，组织机构代码">
              <a-input v-model:value="form.organizationCode" disabled />
            </a-form-item>
          </a-col>
          <a-col v-bind="colLayout.cols">
...
min="0"
          ...
          <a-col v-bind="colLayout.cols">
            <a-form-item name="socialSecurityRegistration" label="社会保险登记证">
              <a-input v-model:value="form.socialSecurityRegistration" disabled />
            </a-form-item>
          </a-col>
          <a-col v-bind="colLayout.cols">
          ...
          <a-col v-bind="colLayout.cols">
            <a-form-item name="postOfficeBox" label="邮政信箱">
              <a-input v-model:value="form.postOfficeBox" disabled />
            </a-form-item>
          </a-col>
          <a-col v-bind="colLayout.cols">
            <a-form-item name="companyUrl" label="公司网址">
              <a-input v-model:value="form.companyUrl" disabled />
            </a-form-item>
          </a-col>
          <a-col v-bind="colLayout.cols">
          ...
          <a-col v-bind="colLayout.cols">
            <a-form-item name="vendorBusinessRange" label="经营范围">
              <a-input v-model:value="form.vendorBusinessRange" disabled />
            </a-form-item>
          </a-col>
          <a-col v-bind="colLayout.cols">
            <a-form-item name="vendorCapabilityRange" label="能力范围">
              <a-input v-model:value="form.vendorCapabilityRange" disabled />
            </a-form-item>
          </a-col>
          <a-col v-bind="colLayout.cols">
            <a-form-item name="vendorApproveRange" label="批准范围">
              <a-input v-model:value="form.vendorApproveRange" disabled />
            </a-form-item>
          </a-col>
          <a-col v-bind="colLayout.cols">
          ...
          <a-col v-bind="colLayout.cols">
            <a-form-item name="supplierFileNo" label="供方档案号">
              <a-input v-model:value="form.supplierFileNo" disabled />
            </a-form-item>
          </a-col>
          <a-col v-bind="colLayout.cols">
            <a-form-item name="countyTown" label="供方所在市（县）/城市">
              <a-input v-model:value="form.countyTown" disabled />
            </a-form-item>
          </a-col>
          <a-col v-bind="colLayout.cols">
            <a-form-item name="contactPeople" label="联系人（SF）">
              <a-input v-model:value="form.contactPeople" disabled />
            </a-form-item>
          </a-col>
          <a-col v-bind="colLayout.cols">
          ...
          <a-col v-bind="colLayout.cols">
            <a-form-item name="city" label="省市名称（SF）">
              <a-input v-model:value="form.city" disabled />
            </a-form-item>
          </a-col>
          <a-col v-bind="colLayout.cols">
            <a-form-item name="country" label="国家名称（SF）">
              <a-input v-model:value="form.country" disabled />
            </a-form-item>
          </a-col>
          <a-col v-bind="colLayout.cols">
          ...
          <a-col v-bind="colLayout.cols">
            <a-form-item name="registeredCapital" label="注册资金（万元）">
              <a-input v-model:value="form.registeredCapital" disabled />
            </a-form-item>
          </a-col>
          <a-col v-bind="colLayout.cols">
          ...
          <a-col v-bind="colLayout.cols">
            <a-form-item name="receivedCapital" label="实收资本（万元）">
              <a-input v-model:value="form.receivedCapital" disabled />
            </a-form-item>
          </a-col>
          <a-col v-bind="colLayout.cols">
          ...
          <a-col v-bind="colLayout.cols">
            <a-form-item name="produceAddress" label="供应商生产地址">
              <a-input v-model:value="form.produceAddress" disabled />
            </a-form-item>
          </a-col>
          <a-col v-bind="colLayout.cols">
            <a-form-item name="sysProvince" label="`省份/直辖市`">
              <a-input v-model:value="form.sysProvince" disabled />
            </a-form-item>
          </a-col>
          <a-col v-bind="colLayout.cols">
            <a-form-item name="registerMoney" label="注册资产（SF）">
              <a-input v-model:value="form.registerMoney" disabled />
            </a-form-item>
          </a-col>
        </a-row>
      </a-form>
      <MdsVendorAccountEdit
        ref="mdsVendorAccountEdit"
        :mainId="formId"
        :readOnly="true"
      ></MdsVendorAccountEdit>
    </a-spin>
