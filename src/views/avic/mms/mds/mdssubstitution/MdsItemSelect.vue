<template>
   <a-modal :visible="visible" @ok="handleOk" @cancel.once="handleCancel" title="物料选择" width="80%">
        ...
        <a-row :gutter="16">
          <a-col v-bind="colLayout.cols">
            <a-form-item label="物料号 ">
              <a-input
                v-model:value="queryForm.itemCode"
                placeholder="请输入物料号 "
                :allow-clear="true"
          ...
          <a-col v-bind="colLayout.cols">
            <a-form-item label="物料名称 ">
              <a-input
                v-model:value="queryForm.itemName"
                placeholder="请输入物料名称 "
                :allow-clear="true"
                @pressEnter="handleQuery"
              />
          ...
          <a-col v-bind="colLayout.cols">
            <a-form-item label="图号">
              <a-input
                v-model:value="queryForm.drawingCode"
                placeholder="请输入图号"
                :allow-clear="true"
                @pressEnter="handleQuery"
              />
...
//确定
const handleOk = () => {
  $emit('getItemId', selectedRows.value[0])
  $emit('getTdItemId', selectedRows.value[0])
}
//取消
const handleCancel = () => {
  $emit('closeCancel')
