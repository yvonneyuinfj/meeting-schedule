       ...
       >
        <a-row :gutter="16">
          <a-col v-bind="colLayout.cols">
            <a-form-item name="invTransactTypeCode" label="库存事务处理类型">
              <a-input v-model:value="form.invTransactTypeCode" :auto-focus="true" disabled />
            </a-form-item>
          </a-col>
          <a-col v-bind="colLayout.cols">
            <a-form-item name="invTransactTypeDesc" label="库存事务类型说明">
              <a-input v-model:value="form.invTransactTypeDesc" disabled />
            </a-form-item>
          </a-col>
          <a-col v-bind="colLayout.cols">
            <a-form-item name="operationSource" label="操作来源代码">
              <a-select
          ...
          <a-col v-bind="colLayout.cols">
            <a-form-item name="operationType" label="操作类型">
              <a-select
          ...
          <a-col v-bind="colLayout.cols">
            <a-form-item name="keepAccountFlag" label="是否登帐标记">
              <a-select
          ...
          <a-col v-bind="colLayout.cols">
            <a-form-item name="changeInvQtyFlag" label="库房总数量变化标记">
              <a-select
          ...
          <a-col v-bind="colLayout.cols">
            <a-form-item name="prefixCode" label="单据前缀">
              <a-input v-model:value="form.prefixCode" disabled />
            </a-form-item>
          </a-col>
          <a-col v-bind="colLayout.cols">
            <a-form-item name="reportName" label="单据报表名称">
              <a-input v-model:value="form.reportName" disabled />
            </a-form-item>
          </a-col>
          <a-col v-bind="colLayout.cols">
          ...
          <a-col v-bind="colLayout.cols">
            <a-form-item name="validFlag" label="有效标记">
              <a-select
          ...
          <a-col v-bind="colLayout.cols">
            <a-form-item name="ynEnableChoose" label="是否允许选择">
              <a-input v-model:value="form.ynEnableChoose" disabled />
            </a-form-item>
          </a-col>
          <a-col v-bind="colLayout.cols">
