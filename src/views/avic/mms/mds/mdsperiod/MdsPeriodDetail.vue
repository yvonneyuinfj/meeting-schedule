...
min="0"
          ...
          <a-col v-bind="colLayout.cols">
            <a-form-item name="orderNo" label="期段号">
              <a-input-number
...
min="0"
          ...
          <a-col v-bind="colLayout.cols">
            <a-form-item name="arrangeDate" label="开始日期">
              <a-date-picker
          ...
          <a-col v-bind="colLayout.cols">
            <a-form-item name="periodType" label="期段类型 ^ 取自通用代码APPLICATION_TYPE:  1-日,2-周,3-月,4-季度,5-年份'">
              <a-select
...
min="0"
          ...
          <a-col v-bind="colLayout.cols">
            <a-form-item name="applicationType" label="期段应用类型 ^  取自通用代码APPLICATION_TYPE:  1-生产,2-采购,3-库存,4-成本'">
              <a-select
