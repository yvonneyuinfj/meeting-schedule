        ...
        <a-row :gutter="16">
          <a-col v-bind="colLayout.cols">
            <a-form-item name="title" label="标题">
              <a-input v-model:value="form.title" :auto-focus="true" disabled />
            </a-form-item>
          </a-col>
          <a-col v-bind="colLayout.cols">
          ...
          <a-col v-bind="colLayout.cols">
            <a-form-item name="moduleNameEn" label="模块英文名">
              <a-input v-model:value="form.moduleNameEn" disabled />
            </a-form-item>
          </a-col>
          <a-col v-bind="colLayout.cols">
          ...
          <a-col v-bind="colLayout.cols">
            <a-form-item name="receiver" label="接收人ID">
              <AvicCommonSelect
                ...
                type="userSelect"
                :defaultShowValue="form.receiverAlias"
                disabled
              />
            </a-form-item>
          </a-col>
          ...
          <a-col v-bind="colLayout.cols">
            <a-form-item name="jumpAddress" label="跳转地址">
              <a-input v-model:value="form.jumpAddress" disabled />
            </a-form-item>
          </a-col>
          <a-col v-bind="colLayout.cols">
