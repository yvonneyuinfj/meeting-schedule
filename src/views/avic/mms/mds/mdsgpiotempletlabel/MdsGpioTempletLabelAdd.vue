      ...
      <a-form ref="formRef" :model="form" :rules="rules" v-bind="layout" layout="horizontal">
        <a-row :gutter="16">
          <a-col v-bind="colLayout.cols">
            <a-form-item name="lableName" label="标签名称" has-feedback>
              <a-input v-model:value="form.lableName" :maxLength="512" :auto-focus="true" placeholder="请输入标签名称" />
            </a-form-item>
          </a-col>
          <a-col v-bind="colLayout.cols">
            <a-form-item name="fieldName" label="字段名称" has-feedback>
              <a-input v-model:value="form.fieldName" :maxLength="512" placeholder="请输入字段名称" />
            </a-form-item>
          </a-col>
          <a-col v-bind="colLayout.cols">
            <a-form-item name="fieldDesc" label="字段说明">
              <a-input v-model:value="form.fieldDesc" :maxLength="2048" placeholder="请输入字段说明" />
            </a-form-item>
          </a-col>
          <a-col v-bind="colLayout.cols">
