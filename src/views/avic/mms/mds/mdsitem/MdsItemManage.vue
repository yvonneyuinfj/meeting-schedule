<template>
  <div class="content-wrapper">
        ...
        <a-row :gutter="16">
          ...
          <!-- <a-col v-bind="colLayout.cols" v-show="advanced">
            <a-form-item label="物料类型 ">
              <a-select
                v-model:value="queryForm.itemType"
          ...
          <a-col v-bind="colLayout.cols" v-show="advanced">
            <a-form-item label="关重件标记">
              <a-select
                v-model:value="queryForm.keyFlag"
                :get-popup-container="triggerNode => triggerNode.parentNode"
                option-filter-prop="children"
                :show-search="true"
                :allow-clear="true"
                placeholder="请选择关重件标记"
              >
                <a-select-option
                  v-for="item in keyFlagList"
                  :key="item.sysLookupTlId"
                  :value="item.lookupCode"
                >
                  {{ item.lookupName }}
          ...
          <a-col v-bind="colLayout.cols" v-show="advanced">
            <a-form-item label="主制部门">
              <AvicCommonSelect
                v-model:value="queryForm.mainHrDeptId"
                type="deptSelect"
                placeholder="请选择主制部门"
                :defaultShowValue="queryForm.mainHrDeptIdAlias"
                @callback="
                  result => {
          ...
          <a-col v-bind="colLayout.cols" v-show="advanced">
            <a-form-item label="物料大类">
              <a-input
                v-model:value="queryForm.mdsItemClassId"
                placeholder="请输入物料大类"
                :allow-clear="true"
                @pressEnter="handleQuery"
              />
          ...
          <a-col v-bind="colLayout.cols" v-show="advanced">
            <a-form-item label="版本号 ">
              <a-input
                v-model:value="queryForm.itemRevision"
                placeholder="请输入版本号 "
                :allow-clear="true"
                @pressEnter="handleQuery"
              />
          ...
          <a-col v-bind="colLayout.cols" v-show="advanced">
            <a-form-item label="适用产品">
              <a-select
                v-model:value="queryForm.appProductCode"
                :get-popup-container="triggerNode => triggerNode.parentNode"
                option-filter-prop="children"
                :show-search="true"
                :allow-clear="true"
              ...
              >
                <a-select-option
                  v-for="item in appProductCodeList"
                  :key="item.sysLookupTlId"
                  :value="item.lookupCode"
                >
                  {{ item.lookupName }}
          ...
          <a-col v-bind="colLayout.cols" v-show="advanced">
            <a-form-item label="物料状态 ">
              <a-select
                v-model:value="queryForm.mdsItemStatus"
                :get-popup-container="triggerNode => triggerNode.parentNode"
                option-filter-prop="children"
                :show-search="true"
                :allow-clear="true"
              ...
              >
                <a-select-option
                  v-for="item in mdsItemStatusList"
                  :key="item.sysLookupTlId"
                  :value="item.lookupCode"
                >
                  {{ item.lookupName }}
          ...
          <a-col v-bind="colLayout.cols" v-show="advanced">
            <a-form-item label="扩展属性合并显示文本 ">
              <a-input
                v-model:value="queryForm.extendText"
                placeholder="请输入扩展属性合并显示文本 "
                :allow-clear="true"
                @pressEnter="handleQuery"
              />
            </a-form-item>
          ...
          <a-col v-bind="colLayout.cols" v-show="advanced">
            <a-form-item label="原始物料编码">
              <a-input
                v-model:value="queryForm.originalItemCode"
                placeholder="请输入原始物料编码"
                :allow-clear="true"
                @pressEnter="handleQuery"
              />
            </a-form-item>
          ...
          <a-col v-bind="colLayout.cols" v-show="advanced">
            <a-form-item label="物料基础码">
              <a-input
                v-model:value="queryForm.extendItemCode"
                placeholder="请输入物料基础码"
                :allow-clear="true"
                @pressEnter="handleQuery"
              />
            </a-form-item>
          ...
          <a-col v-bind="colLayout.cols" v-show="advanced">
            <a-form-item label="制造国名称">
              <a-input
                v-model:value="queryForm.makeCountry"
                placeholder="请输入制造国名称"
                :allow-clear="true"
                @pressEnter="handleQuery"
              />
            </a-form-item>
          ...
          <a-col v-bind="colLayout.cols" v-show="advanced">
            <a-form-item label="牌号代码">
              <a-input
                v-model:value="queryForm.marqueCode"
                placeholder="请输入牌号代码"
                :allow-clear="true"
                @pressEnter="handleQuery"
              />
          ...
          <a-col v-bind="colLayout.cols" v-show="advanced">
            <a-form-item label="交货状态代码">
              <a-input
                v-model:value="queryForm.deliveryStatusCode"
                placeholder="请输入交货状态代码"
                :allow-clear="true"
                @pressEnter="handleQuery"
              />
            </a-form-item>
          ...
          <a-col v-bind="colLayout.cols" v-show="advanced">
            <a-form-item label="数据来源">
              <a-select
                v-model:value="queryForm.dataSource"
                :get-popup-container="triggerNode => triggerNode.parentNode"
                option-filter-prop="children"
                :show-search="true"
                :allow-clear="true"
          ...
          <a-col v-bind="colLayout.cols" v-show="advanced">
            <a-form-item label="技术条件代码">
              <a-input
                v-model:value="queryForm.techConditionCode"
                placeholder="请输入技术条件代码"
                :allow-clear="true"
                @pressEnter="handleQuery"
              />
            </a-form-item>
          ...
          <a-col v-bind="colLayout.cols" v-show="advanced">
            <a-form-item label="浪潮代码">
              <a-input
                v-model:value="queryForm.lcCode"
                placeholder="请输入浪潮代码"
                :allow-clear="true"
                @pressEnter="handleQuery"
              />
          ...
          <a-col v-bind="colLayout.cols" v-show="advanced">
            <a-form-item label="补充技术条件">
              <a-input
                v-model:value="queryForm.additionalTechCondition"
                placeholder="请输入补充技术条件"
                :allow-clear="true"
                @pressEnter="handleQuery"
              />
            </a-form-item>
          ...
          <a-col v-bind="colLayout.cols" v-show="advanced">
            <a-form-item label="供货尺寸类别">
              <a-input
                v-model:value="queryForm.deliverySizeType"
                placeholder="请输入供货尺寸类别"
                :allow-clear="true"
                @pressEnter="handleQuery"
              />
            </a-form-item>
          ...
          <a-col v-bind="colLayout.cols" v-show="advanced">
            <a-form-item label="承制单位">
              <a-input
                v-model:value="queryForm.manufactor"
                placeholder="请输入承制单位"
                :allow-clear="true"
                @pressEnter="handleQuery"
              />
          ...
          <a-col v-bind="colLayout.cols" v-show="advanced">
            <a-form-item label="锻铸件类别">
              <a-input
                v-model:value="queryForm.dzType"
                placeholder="请输入锻铸件类别"
                :allow-clear="true"
                @pressEnter="handleQuery"
              />
            </a-form-item>
          ...
          <a-col v-bind="colLayout.cols" v-show="advanced">
            <a-form-item label="试料数量">
              <a-input
                v-model:value="queryForm.testamount"
                placeholder="请输入试料数量"
                :allow-clear="true"
                @pressEnter="handleQuery"
              />
          ...
          <a-col v-bind="colLayout.cols" v-show="advanced">
            <a-form-item label="关键件等级 ">
              <a-input
                v-model:value="queryForm.keyLevel"
                placeholder="请输入关键件等级 "
                :allow-clear="true"
                @pressEnter="handleQuery"
              />
            </a-form-item>
          ...
          <a-col v-bind="colLayout.cols" v-show="advanced">
            <a-form-item label="是否关键原材料">
              <a-select
                v-model:value="queryForm.ynKeyMaterial"
                :get-popup-container="triggerNode => triggerNode.parentNode"
                option-filter-prop="children"
                :show-search="true"
                :allow-clear="true"
                placeholder="请选择是否关键原材料"
              >
                <a-select-option
                  v-for="item in ynKeyMaterialList"
                  :key="item.sysLookupTlId"
                  :value="item.lookupCode"
                >
                  {{ item.lookupName }}
          ...
          <a-col v-bind="colLayout.cols" v-show="advanced">
            <a-form-item label="民机对应项目ID">
              <a-input
                v-model:value="queryForm.mpmId"
                placeholder="请输入民机对应项目ID"
                :allow-clear="true"
                @pressEnter="handleQuery"
              />
            </a-form-item>
          ...
          <a-col v-bind="colLayout.cols" v-show="advanced">
            <a-form-item label="定倍尺标识">
              <a-input
                v-model:value="queryForm.fixedFlag"
                placeholder="请输入定倍尺标识"
                :allow-clear="true"
                @pressEnter="handleQuery"
              />
            </a-form-item>
          ...
          <a-col v-bind="colLayout.cols" v-show="advanced">
            <a-form-item label="机型代号主数据编码">
              <a-input
                v-model:value="queryForm.jxdhbm"
                placeholder="请输入机型代号主数据编码"
                :allow-clear="true"
                @pressEnter="handleQuery"
              />
            </a-form-item>
          ...
          <a-col v-bind="colLayout.cols" v-show="advanced">
            <a-form-item label="规格数据">
              <a-input
                v-model:value="queryForm.mdmSpecs"
                placeholder="请输入规格数据"
                :allow-clear="true"
                @pressEnter="handleQuery"
              />
          ...
          <a-col v-bind="colLayout.cols" v-show="advanced">
            <a-form-item label="是否关键站位">
              <a-select
                v-model:value="queryForm.ynKeyZw"
                :get-popup-container="triggerNode => triggerNode.parentNode"
                option-filter-prop="children"
                :show-search="true"
                :allow-clear="true"
                placeholder="请选择是否关键站位"
              >
                <a-select-option
                  v-for="item in ynKeyZwList"
                  :key="item.sysLookupTlId"
                  :value="item.lookupCode"
                >
                  {{ item.lookupName }}
    ...
    <div class="table-wrapper">
      <AvicTable ref="mdsItem" table-key="mdsItem" :columns="columns" :row-key="record => record.id" :data-source="list"
        ...
        <template #toolBarLeft>
          <a-space>
            <a-button v-hasPermi="['mdsItem:add']" title="添加" type="primary" @click="handleAdd">
              <template #icon>
                <plus-outlined />
              </template>
              添加
            </a-button>
            <a-button v-hasPermi="['mdsItem:del']" title="删除" danger
            ...
            <a-button v-hasPermi="['mdsItem:import']" title="导入" type="primary" ghost @click="handleImport">
              <template #icon>
                <import-outlined />
              </template>
              导入
            </a-button>
            <a-button v-hasPermi="['mdsItem:export']" title="导出" type="primary" ghost @click="handleExport">
              <template #icon>
                <export-outlined />
              </template>
              导出
        ...
        <template #bodyCell="{ column, text, record, index }">
          ...
          <template v-else-if="column.dataIndex === 'itemCode'">
            <a @click="handleDetail(record)">
              {{ record.itemCode }}
            </a>
          </template>
          <template v-else-if="column.dataIndex === 'action'">
            <a-button type="link" class="inner-btn" @click.stop="handleEdit(record)">
              编辑
            </a-button>
            <a-button v-hasPermi="['mdsItem:del']" type="link" class="inner-btn"
    ...
    <!-- 添加页面弹窗 -->
    <mds-item-add v-if="showAddModal" ref="addModal" @reloadData="getList" @close="showAddModal = false" />
    <!-- 编辑页面弹窗 -->
    <mds-item-edit v-if="showEditModal" ref="editModal" :form-id="formId" @reloadData="getList"
      @close="showEditModal = false" :parent-id="parentNodeId" :parent-title="parentTitle" />
    <!-- 详情页面弹窗 -->
    <mds-item-detail v-if="showDetailModal" ref="detailModal" :form-id="formId" @close="showDetailModal = false"
      :parent-id="parentNodeId" :parent-title="parentTitle" />
    <AvicExcelImport v-if="showImportModal" :formData="excelParams" title="单表模板导入"
      importUrl="/mms/mds/mdsitems/importData/v1" downloadTemplateUrl="/mms/mds/mdsitems/downloadTemplate/v1"
      @reloadData="getList" @close="showImportModal = false" />
  </div>
</template>
<script lang="ts" setup>
import type { MdsItemDto } from '@/api/avic/mms/mds/MdsItemApi'; // 引入模块DTO
import { listMdsItemByPage, delMdsItem, exportExcel } from '@/api/avic/mms/mds/MdsItemApi'; // 引入模块API
import MdsItemAdd from './MdsItemAdd.vue'; // 引入添加页面组件
import MdsItemEdit from './MdsItemEdit.vue'; // 引入编辑页面组件
import MdsItemDetail from './MdsItemDetail.vue'; // 引入详情页面组件
...
const excelParams = ref({ tableName: 'mdsItem' }); // 导入Excel数据过滤参数
const advanced = ref(false); // 高级搜索 展开/关闭
const list = ref([]); // 表格数据集合
const formId = ref(''); // 当前行数据id
const parentNodeId = ref(''); // 添加节点的初始父节点
const parentTitle = ref(''); // 添加节点的初始父节点
...
function handleEdit(row) {
  formId.value = row.id;
  parentNodeId.value = row.mdsItemClassId;
  parentTitle.value = row.mdsItemClassName;
