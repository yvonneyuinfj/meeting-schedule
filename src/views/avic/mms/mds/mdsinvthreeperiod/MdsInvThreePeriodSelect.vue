<template>
  <div class="content-wrapper">
    ...
    <div class="table-wrapper">
      <AvicTable
        ref="mdsInvThreePeriodSelect"
        table-key="mdsInvThreePeriodSelect"
        :columns="columns"
...
import { listMdsInvThreePeriodByPage } from '@/api/avic/mms/mds/MdsInvThreePeriodApi'; // 引入模块API
const $emit = defineEmits(['select', 'handleRowDblClick']);
const mdsInvThreePeriodSelect = ref();
