      ...
      <a-form
       ...
       >
        <a-row :gutter="16">
          ...
          <a-col v-bind="colLayout.cols">
            <a-form-item name="releaseUserId" label="发布人" has-feedback>
              <AvicCommonSelect
                v-model:value="form.releaseUserId"
                type="userSelect"
                placeholder="请选择发布人"
                :defaultShowValue="form.releaseUserIdAlias"
                @callback="getSelectUserCode($event,'releaseUserCode','releaseUserName')"
              />
            </a-form-item>
          </a-col>
          <a-col v-bind="colLayout.cols">
            <a-form-item name="releaseUserCode" label="发布人职工号">
              <a-input
