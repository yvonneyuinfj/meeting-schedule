<template>
  <div class="content-wrapper">
    ...
    <div class="table-wrapper">
      <AvicTable
        ref="pmsCheckBillSelect"
        table-key="pmsCheckBillSelect"
        :columns="columns"
...
import { listPmsCheckBillByPage } from '@/api/avic/mms/pms/PmsCheckBillApi'; // 引入模块API
const $emit = defineEmits(['select', 'handleRowDblClick']);
const pmsCheckBillSelect = ref();
