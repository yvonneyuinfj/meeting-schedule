<template>
  <div class="content-wrapper">
    ...
    <div class="table-wrapper">
      <AvicTable
        ref="pmsCheckItemSelect"
        table-key="pmsCheckItemSelect"
        :columns="columns"
...
import { listPmsCheckItemByPage } from '@/api/avic/mms/pms/PmsCheckItemApi'; // 引入模块API
const $emit = defineEmits(['select', 'handleRowDblClick']);
const pmsCheckItemSelect = ref();
