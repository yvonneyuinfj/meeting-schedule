<template>
  <div class="content-wrapper">
    ...
    <div class="table-wrapper">
      <AvicTable
        ref="pmsCheckTmplSelect"
        table-key="pmsCheckTmplSelect"
        :columns="columns"
...
import { listPmsCheckTmplByPage } from '@/api/avic/mms/pms/PmsCheckTmplApi'; // 引入模块API
const $emit = defineEmits(['select', 'handleRowDblClick']);
const pmsCheckTmplSelect = ref();
