export default {
  ...
  'app.setting.layout.side': 'H+',
  'app.setting.layout.top': '传统',
  'app.setting.layout.mix': '简约',
  ...
  'app.setting.themecolor.blue-initial': '默认',
  'app.setting.themecolor.blue': '蓝色',
  'app.setting.themecolor.red': '红色',
  'app.setting.themecolor.purple': '紫色',
  'app.setting.themecolor.green': '绿色',
  'app.setting.themecolor.ashen': '灰白',
