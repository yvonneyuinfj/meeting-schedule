          ...
          >
            <template #bodyCell="{ record }">
              <span class="user-icon">
                <avic-icon color="#24b3b3" svg="avic-team-fill" />
              </span>
              ...
              <span class="cell-popover">
                <a-tooltip>
                  <template #title>
                    <p style="margin: 0">
                      {{ record['groupDesc'] ? record['groupDesc'] : '暂无描述' }}
                    </p>
                  </template>
          ...
          >
            <template #bodyCell="{ column, text, record }">
              <template v-if="column.key === 'groupName'">
                <span class="" :title="record['groupName']">
                  <avic-icon svg="avic-team-fill" style="color: #24b3b3; margin-right: 4px" />
                  {{ text }}
