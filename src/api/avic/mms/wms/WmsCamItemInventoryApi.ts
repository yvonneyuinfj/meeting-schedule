...
const basePath = '/mms/wms/wmscamiteminventorys';
/** 顾客财产台账表 */
export interface WmsCamItemInventoryDto extends BaseBeanModel {
...
/** 获取分页数据 */
export function listWmsCamItemInventoryByPage (
  param: QueryParamModel
): Promise<ResponsePageData<WmsCamItemInventoryDto>> {
  return request.post(basePath + '/search-by-page/v1', param);
}

/** 根据id加载数据 */
export function getWmsCamItemInventory (id: string): Promise<ResponseBaseData<WmsCamItemInventoryDto>> {
  return request.get(basePath + '/get/' + id + '/v1');
}

/** 保存表单数据 */
export function saveWmsCamItemInventory (form: WmsCamItemInventoryDto): Promise<ResponseBaseData<any>> {
  return request.post(basePath + '/save/v1', form);
}

/** 根据id集合删除数据 */
export function delWmsCamItemInventory (ids: [string]): Promise<ResponseBaseData<any>> {
