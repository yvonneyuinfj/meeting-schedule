...
export interface FamInventoryChangeDto extends BaseBeanModel {
  ...
  bpmType?: string;
  /** 子表集合 */
  famInventoryChangeListList?: [];
}

/** 获取分页数据 */
export function listFamInventoryChangeByPage(param: QueryParamModel): Promise<ResponsePageData<FamInventoryChangeDto>> {
...
/** 根据id集合删除数据 */
export function delFamInventoryChange(ids: [string]): Promise<ResponseBaseData<any>> {
